                  ...
                  <div className="mt-10 flex w-full flex-col">
                    <div className="relative my-3 w-full rounded-md px-6 py-8">
                      <div className="max-w-full">
                        ...
                        <p className="font-inter text-base font-light text-gray-500 text-justify">{indexLanguageText.h2_1_p1}</p>
                      </div>
                    </div>
                    ...
                    <div className="relative my-3 w-full rounded-md px-6 py-8">
                      <div className="max-w-full">
                        ...
                        <p className="font-inter text-base font-light text-gray-500 text-justify">{indexLanguageText.h2_2_p1}</p>
                      </div>
                    </div>
                    <div className="mr-4 ml-8 border border-gray-200"></div>
                    <div className="relative my-3 w-full rounded-md px-6 py-8">
                      <div className="max-w-full">
                        ...
                        <p className="font-inter text-base font-light text-gray-500 text-justify">{indexLanguageText.h2_3_p1}</p>
                      </div>
                    </div>
                    <div className="mr-4 ml-8 border border-gray-200"></div>
